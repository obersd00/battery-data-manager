...
plt.ylabel('Specific Discharge Capacity (mAh / g)',fontname=font,fontsize=20,labelpad=10)
plt.yticks(fontname=font,fontsize=12)
plt.xlabel('Cycle Number',fontname=font,fontsize=20,labelpad=20)
plt.xticks(fontname=font,fontsize=12)
x='[insert dataset name]'
plt.title('Cycle life of %s' %x, fontname=font,fontsize=20)
